...
import { PiggyBank, Droplets, Calendar, RotateCw, Play, ShoppingBag, Landmark, AlertCircle, Brain, TrendingUp, CheckCircle } from 'lucide-react';
    ...
    <div className="space-y-8 animate-fade-in max-w-5xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#15221c] border border-[#1e332a] rounded-3xl p-6 flex flex-col items-center text-center hover:border-green-500/30 transition-colors">
          ...
          <h3 className="text-3xl font-bold text-white mb-1">{formatCurrency(data.totalPotential)}</h3>
