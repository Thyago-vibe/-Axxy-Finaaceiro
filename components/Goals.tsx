...
import { Target, Plus, Trophy, Calendar, TrendingUp, X, Lightbulb } from 'lucide-react';
                ...
                <div key={goal.id} className="bg-axxy-card border border-axxy-border p-6 rounded-3xl">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">{formatCurrency(goal.currentAmount)} / {formatCurrency(goal.targetAmount)}</p>
                    </div>
