    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-axxy-card p-6 rounded-3xl border border-axxy-border">
          ...
          <h3 className="text-3xl font-bold text-white">R$ {balance.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
        </div>
        <div className="bg-axxy-card p-6 rounded-3xl border border-axxy-border">
          <p className="text-gray-400 text-sm mb-1">Receitas (Mês Atual)</p>
          <div className="flex items-center gap-2">
            <h3 className="text-3xl font-bold text-white">R$ {incomeMonth.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
        ...
        <div className="bg-axxy-card p-6 rounded-3xl border border-axxy-border">
          ...
          <div className="flex items-center gap-2">
            <h3 className="text-3xl font-bold text-white">R$ {expenseMonth.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
